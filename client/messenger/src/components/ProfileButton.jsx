...
const ProfileButton = () => {
  ...
  return user ? (
    <button
      ...
      className="flex items-center space-x-2 bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-gray-300 hover:text-blue-600 transition-all duration-200 shadow-sm"
    >
      <img
